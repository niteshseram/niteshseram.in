...
option and configure the 2-Step Verification. If you have configured from
before, then you will see the _App passwords_ option.
<br />
<CImage
...
<CImage
	...
	height={339}
/>
Then, we will get your password which is going to be your `SMTP_PASSWORD`. And
your `SMTP_USER` will be that Gmail address.
