...
<Image
	...
	src='/static/blog/open-source-journey/banner.png'
	width={2560 / 3}
	height={1440 / 3}
	priority
/>
...
Before I begin to tell you about my journey in Open Source, let us
...
<br />
So, Open Source Contribution means a contribution to the development or improvement
...
You can find some of my PR in this project [here](https://github.com/freeCodeCamp/freeCodeCamp/pulls?q=is%3Apr+author%3Aniteshseram).
...
<br />
You can find about the workshop [here](https://github.com/kubernetes-sigs/contributor-playground/tree/master/india/kcd-blr-2021).
You can see me in the below picture in a blue T-Shirt smiling😅. This was a picture
from that workshop.

<br />
<CImage
	alt='Workshop Picture'
	src='/static/blog/open-source-journey/workshop.jpg'
	width={3544 / 4}
	height={2026 / 4}
/>
...
<br />
You can find some of the PR that I made in Kubernetes [here](https://github.com/kubernetes/website/pulls?q=author%3Aniteshseram+).

### Why contribute to Open Source?

You learn a lot while contributing to open source.
...
- **Is there any prerequisite to contribute to open source?**
  ...
  There is no prerequisite to get started in open source. You just need to be ready to learn things in the way.
