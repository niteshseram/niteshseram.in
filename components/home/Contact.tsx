...
const Contact = () => {
  return (
		<section id='contact' className='mb-10 mt-20'>
			...
			<p>
				Looking to collaborate, discuss an opportunity, or just want to
				say hi? I&apos;m all in!
			</p>
			<p className='mt-5'>
				Just drop me an email at{' '}
				<Link href='mailto:contact@niteshseram.in' className='link'>
					contact@niteshseram.in
				</Link>
				, or hit me up on{' '}
				<Link href='https://twitter.com/niteshseram' className='link' target='_blank'>
					Twitter
				</Link>{' '}
