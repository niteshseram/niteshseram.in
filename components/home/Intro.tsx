...
const Intro = () => {
	...
	return (
		<section
			ref={refSection}
			id='intro'
			className='flex min-h-screen flex-col items-center justify-center py-24 text-2xl font-semibold tracking-tight md:py-28 md:text-3xl lg:py-3 lg:text-5xl'
		>
			<div className='leading-[1.15]'>
				...
				>
					I&apos;m passionate about crafting user-friendly and complex web
					applications.
				</span>
				<span
