...
![Contact Form in Nextjs with Nodemailer](/images/blog/nextjs-with-nodemailer/banner.webp)
...
![Manage Google Account](/images/blog/nextjs-with-nodemailer/img1.webp)
...
![2 Step Verification](/images/blog/nextjs-with-nodemailer/img2.webp)
![App passwords](/images/blog/nextjs-with-nodemailer/img3.webp)
Click on App passwords and select the options as below image.

![App passwords options](/images/blog/nextjs-with-nodemailer/img4.webp)
...
![Vercel Project settings](/images/blog/nextjs-with-nodemailer/img5.webp)

Then, you have to provide the name and value for that environment variables `SMTP_USER` and `SMTP_PASSWORD` like below image.

![Vercel Environment variables](/images/blog/nextjs-with-nodemailer/img6.webp)
