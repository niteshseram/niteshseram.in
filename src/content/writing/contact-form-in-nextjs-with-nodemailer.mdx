...
summary: 'Build a Next.js contact form that sends email through a Nodemailer API endpoint, Gmail SMTP credentials, and environment variables.'
---

![](/images/blog/nextjs-with-nodemailer/banner.webp)
...
![Gmail account menu with the Manage your Google Account button](/images/blog/nextjs-with-nodemailer/img1.webp)
...
![Google Account Security page showing 2-Step Verification turned off](/images/blog/nextjs-with-nodemailer/img2.webp)
![Google Account Security page showing 2-Step Verification on and the App passwords option](/images/blog/nextjs-with-nodemailer/img3.webp)
Click on App passwords and select the options as below image.

![Google App passwords form with Mail and Windows Computer selected](/images/blog/nextjs-with-nodemailer/img4.webp)
...
![Vercel Project Settings page showing the General settings](/images/blog/nextjs-with-nodemailer/img5.webp)

Then, you have to provide the name and value for that environment variables `SMTP_USER` and `SMTP_PASSWORD` like below image.

![Vercel Environment Variables form with SMTP_USER configured for all environments](/images/blog/nextjs-with-nodemailer/img6.webp)
