...
summary: 'Set up ESLint, Prettier, Husky, and lint-staged in a Next.js project so linting and formatting run before commits.'
---

![](/images/blog/setting-up-eslint-prettier-and-husky-with-lint-staged-for-your-nextjs-project/banner.webp)
...
![Terminal output from yarn lint showing an import/no-anonymous-default-export warning in pages/api/hello.js](/images/blog/setting-up-eslint-prettier-and-husky-with-lint-staged-for-your-nextjs-project/1.webp)
...
![VS Code showing an unused abc variable without an ESLint warning](/images/blog/setting-up-eslint-prettier-and-husky-with-lint-staged-for-your-nextjs-project/2.webp)
...
![VS Code showing the unused abc variable flagged by ESLint](/images/blog/setting-up-eslint-prettier-and-husky-with-lint-staged-for-your-nextjs-project/3.webp)
In the above image, you can see that the variable `abc` is now underline and is being
caught by ESLint.
![Terminal output from yarn lint showing the no-unused-vars error for abc in pages/index.js](/images/blog/setting-up-eslint-prettier-and-husky-with-lint-staged-for-your-nextjs-project/4.webp)
