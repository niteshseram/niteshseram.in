...
summary: 'Compare pagination, infinite scroll, and windowing for rendering a 10,000-record React list without overwhelming the DOM.'
---
...
The pagination component only controls what the user can request. If records can change between requests, the API also needs a [pagination strategy that avoids duplicate and missing records](/writing/why-pagination-skips-and-duplicates-changing-data).
