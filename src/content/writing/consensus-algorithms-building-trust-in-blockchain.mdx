...
summary: 'How blockchain nodes agree on a ledger, why consensus prevents double spending, and how Proof of Work differs from Proof of Stake.'
---
...
There are various types of consensus algorithms, but two prominent ones are _Proof of Work (PoW)_ and _Proof of Stake (PoS)_.
